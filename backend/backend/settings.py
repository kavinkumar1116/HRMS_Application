...
MONGO_SETTINGS = {
    'db': os.getenv('MONGO_DB_NAME', 'hrms_dev'),
    'host': os.getenv('MONGO_HOST', '127.0.0.1'),
    'port': int(os.getenv('MONGO_PORT', '27017')),
}

if os.getenv('MONGO_USER'):
    MONGO_SETTINGS['username'] = os.getenv('MONGO_USER')
if os.getenv('MONGO_PASSWORD'):
    MONGO_SETTINGS['password'] = os.getenv('MONGO_PASSWORD')
if os.getenv('MONGO_AUTH_SOURCE'):
    MONGO_SETTINGS['authentication_source'] = os.getenv('MONGO_AUTH_SOURCE')
