...
const Locations = () => {
    ...
    const handleDelete = async (id) => {
        if (window.confirm('Are you sure you want to delete this location?')) {
          try {
            await apiClient.delete(`/locations/delete/${id}/`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
          if (editingId) {
            await apiClient.put(`/locations/update/${editingId}/`, form);
            setLocations(prev => 
  ...
  const paged = sorted.slice(startIndex, startIndex + pageSize);
    ...
    <section className="employee-section">
      ...
      {fetching ? (
        <div className="employee-loading">Loading Locations...</div>
      ) : (
